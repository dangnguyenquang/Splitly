...
(
    ...
    CONSTRAINT fk_payment_image_payment
        FOREIGN KEY (payment_id)
            REFERENCES payment_request (payment_id)
            ON DELETE CASCADE
);
...
(
    ...
    group_id                         INT,
    payment_id                       INT,
    payment_remind_at                TIMESTAMP,
    payment_verification_reminder_at TIMESTAMP,
